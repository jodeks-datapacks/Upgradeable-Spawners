function upgradeable_spawners:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    {translate: "upgradeable_spawners.description", fallback: "Upgrade mob spawners"},\
    "",\
    ...
    {text: "modrinth.com/datapack/upgradeable-spawners", color: "#a800a8"},\
    "",\
    "",\
    "",\
    "",\
